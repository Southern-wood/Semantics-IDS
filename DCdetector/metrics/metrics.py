...
def combine_all_evaluation_scores_without_adjust(y_test, pred_labels, anomaly_scores):
    # events_pred = convert_vector_to_events(y_test)
    # events_gt = convert_vector_to_events(pred_labels)
    # Trange = (0, len(y_test))
    # affiliation = pr_from_events(events_pred, events_gt, Trange)
    ...
    precision, recall, F1, support = precision_recall_fscore_support(y_test, pred_labels, average='binary')
    
    # precision_recall_fscore_support(y_test, pred_labels, average='binary')
    # print("TP: ", tp)
    # print("FP: ", fp)
    # print("TN: ", tn)
    # print("FN: ", fn)
