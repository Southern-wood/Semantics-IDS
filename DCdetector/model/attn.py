...
class DAC_structure(nn.Module):
    ...
    def forward(self, queries_patch_size, queries_patch_num, keys_patch_size, keys_patch_num, values, patch_index, attn_mask):
        ...
        # batch_size * channel, n_head, win_size, win_size
        ...
        # batch, n_head, win_size, win_size
...
class AttentionLayer(nn.Module):
    ...
    def forward(self, x_patch_size, x_patch_num, x_ori, patch_index, attn_mask):
        ...
        H = self.n_heads
        # log(f"patch_size shape: {x_patch_size.shape}")
        ...
        # log(f"queries_patch_size shape: {queries_patch_size.shape}")
        # log(f"keys_patch_size shape: {keys_patch_size.shape}")

        # patch_num
        B, L, M = x_patch_num.shape
        # log(f"patch_num shape: {x_patch_num.shape}")
        ...
        # log(f"queries_patch_num shape: {queries_patch_num.shape}")
        # log(f"keys_patch_num shape: {keys_patch_num.shape}")
